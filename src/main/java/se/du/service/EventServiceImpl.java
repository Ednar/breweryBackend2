...
public class EventServiceImpl implements EventService {
    ...
    public EventServiceImpl(EventRepository eventRepository) {
        ...
        eventRepository.save(new Event("1", "Halloweenfest", "Yuck, rough adventure! The skull pulls with punishment, view the galley until it travels. Where is the wet swabbie? Fire me wind, ye old gibbet! Where is the big mate?", LocalDateTime.now(), "halloween2.jpg"));
